...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
      ...
      ADJUST,  KC_LGUI, KC_LALT, KC_LEFT, KC_RGHT, KC_SPC,  KC_BSPC,  KC_DEL, KC_ENT,  KC_UP,   KC_DOWN, KC_DOWN, _______, _______
      ),
  ...
  [_ADJUST] =  LAYOUT(
      ...
      _______, _______, _______, JA_LCBR, JA_RCBR, JA_ENVL,                   _______, _______, _______, _______, _______, _______,
      _______, _______, _______, JA_LPRN, JA_RPRN, JA_TILD,                   KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, _______, _______,
      _______, _______, _______, JA_LBRC, JA_RBRC, _______, _______, _______, _______, _______, _______, _______, _______, _______,
      _______, _______, _______, KC_HOME,  KC_END, _______,  KC_DEL, _______, _______, KC_PGUP, KC_PGDN, _______, _______, _______
      )
};
